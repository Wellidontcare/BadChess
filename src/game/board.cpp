...
chess::Board::Board()
    : m_board_matrix(BOARD_WIDTH, BOARD_HEIGHT, ChessPieceFactory::make(EMPTY_COLOR, EMPTY_ROLE)), m_taken_pieces{}
{
                         ...
                         const int &current_turn_color) const
{
    ...
    const bool takes_piece = m_board_matrix[to]->get_role() != EMPTY_ROLE;
