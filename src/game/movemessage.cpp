...
InvalidMoveMessageWrongColor::InvalidMoveMessageWrongColor(const std::shared_ptr<chess::Piece> &selected_piece) : MoveMessage(selected_piece){}
...
InvalidMoveMessageOutOfRange::InvalidMoveMessageOutOfRange(const std::shared_ptr<chess::Piece> &selected_piece) : MoveMessage(selected_piece) {}
...
InvalidMoveMessageIllegalMove::InvalidMoveMessageIllegalMove(const std::shared_ptr<chess::Piece>& selected_piece) : MoveMessage(selected_piece) {}
...
ValidMoveMessagePieceTaken::ValidMoveMessagePieceTaken(const std::shared_ptr<chess::Piece> &selected_piece, const std::shared_ptr<chess::Piece> &taken_piece, const std::string &from, const std::string &to)
...
ValidMoveMessageJustMoved::ValidMoveMessageJustMoved(const std::shared_ptr<chess::Piece> &selected_piece, const std::string &from, const std::string &to)
